...
export default function Sidebar({ isOpen, onClose }) {
  ...
  const links = [
    ...
    ...(isPrivileged ? [{ to: '/users', icon: Users, label: 'User Management' }] : []),
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-gray-200 bg-sidebar-light transition-transform duration-200 dark:border-gray-700 dark:bg-sidebar-dark lg:static lg:translate-x-0 ${
      ...
      >
        ...
        <div className="border-t border-gray-200 p-4 dark:border-gray-700">
          <p className="text-xs font-semibold text-gray-600 dark:text-gray-400">ألوان الأحداث</p>
